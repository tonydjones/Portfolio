...
public class CustomizedExceptionHandler implements UncaughtExceptionHandler {
    ...
    public void write_to_log(String string){
        log += string + "\n";
    }
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        String stacktrace = log + stringBuffSync.toString();
        printWriter.close();
    ...
    private void writeToFile(String currentStacktrace) {
        try {
            ...
            File outputDirectory = new File(externalStorage + File.separator + "Documents" + File.separator + "Medication Tracker");
            File dir = new File(outputDirectory, "Crash Reports");
