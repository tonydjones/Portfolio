...
public class ConfirmRefill {
    public static void confirm_refill(MainActivity Activity, List<Map<String, Object>> entries) {
        wipe(Activity, "Confirm Medication Refills", () -> confirm_refill(Activity, entries));
            ...
            public void onClick(View v) {
                ...
                warning.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ui_message(Activity, "Medication log updated: Medications refilled.");
