...
public class OldMainActivity extends AppCompatActivity {
    ...
    public boolean client_passwords;
    public boolean distinct_admin_password;
    public boolean record_password;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!check_folders()){
            ui_message("Error: Necessary folders not present and could not be generated");
        }
        ...
        client_passwords = false;
        distinct_admin_password = false;
        record_password = prefs.getBoolean("record_password", false);
    ...
    public void staff_summary(Map<String, Object> client) {
        ...
        Button change_password = new Button(this);
    ...
    public void change_user_password(Map<String, Object> user){
        wipe("Change Your Password", () -> change_user_password(user));
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!pass.getText().toString().equals(confirm.getText().toString())) {
                    ...
                    warning.setMessage("You must enter a new password");
                    warning.show();
                } else if (!current.getText().toString().equals(user.get("password"))) {
                    current.setText("");
                    pass.setText("");
                    confirm.setText("");
                    warning.setNegativeButton("", null);
                    ...
                    history.remove(0);
                    history.remove(0);
                    if (user.get("class").equals("client")){
                        prescriptions(user);
                    }
                    else{
                        staff_summary(user);
                    ...
                    ui_message("Password successfully changed.");
                }
            }
        });
    ...
    public void ui_message(String message){
            ...
            public void onClick(View v) {
                ...
                if (client.get("password") == null){
                    if (pass.getText().toString().equals(long_to_date((long)client.get("admit")).replace("/", ""))){
                        wipe("Create A New Password", () -> client_confirm(entries ,maxes));
                        TextView new_directions = new TextView(getApplicationContext());
                ...
                if (!all.isChecked() && !clients.isChecked() && !prescriptions.isChecked() && !entries.isChecked()){
                    ...
                    warning.setPositiveButton("Generate Spreadsheets", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (success.first){
                                ui_message("Spreadsheet Successfully Generated: " + success.second);
                            }
                            else {
                                if (!check_folders()){
                                    ui_message("Error: Necessary folders not present and could not be generated");
                                    ...
                                    if (success.first){
                                        ...
                                        ui_message("Something went wrong, spreadsheet was not generated");
                ...
                public void onClick(View v) {
                    ...
                    warning.setPositiveButton("Restore", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            ui_message("Backup was restored.");
